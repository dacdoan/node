...
./configure --enable-lto --without-npm --without-amaro --without-corepack --shared-zlib --shared-zstd --shared-sqlite --shared-libuv --shared-brotli --shared-nghttp2 --shared-ngtcp2 --shared-nghttp3 --shared-openssl --openssl-use-def-ca-store --prefix=/usr
  --with-intl=none --without-inspector --without-node-options # For production
  --with-intl=system-icu # For local
